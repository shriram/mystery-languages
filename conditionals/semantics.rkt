...
(define-values (namespaces lang-print-names)
  (make-namespaces-and-lang-print-names (list 'mystery-languages/conditionals/L1/semantics
                                              'mystery-languages/conditionals/L2/semantics
                                              'mystery-languages/conditionals/L3/semantics)))
