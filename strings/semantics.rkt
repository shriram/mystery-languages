...
(define-values (namespaces lang-print-names)
  (make-namespaces-and-lang-print-names (list 'mystery-languages/strings/L1/semantics
                                              'mystery-languages/strings/L2/semantics
                                              'mystery-languages/strings/L3/semantics)))
