...
(define-values (namespaces lang-print-names)
  (make-namespaces-and-lang-print-names (list 'mystery-languages/fields/L1/semantics
                                              'mystery-languages/fields/L2/semantics
                                              'mystery-languages/fields/L3/semantics)))
